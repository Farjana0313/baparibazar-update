  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid main-body">
      ...
      <div class="main-body-content-area-wrapper">
        <service-chanes-com></service-chanes-com>
      </div>
...
import ServiceChanesCom from "@/components/pages_component/ServiceChanesCom";
import PlusIcon from '@/components/utils/PlusIcon.vue';

export default {
  name: "ServiceCharges",
  components: {ServiceChanesCom, AllPopup, Topbar, Sidebar,PlusIcon}
}
</script>
    PlusIcon
