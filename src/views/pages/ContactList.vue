  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid main-body">
      ...
      <div class="main-body-content-area-wrapper">
        <contact-list-com></contact-list-com>
      </div>
...
import ContactListCom from "@/components/pages_component/ContactListCom";
import PlusIcon from '@/components/utils/PlusIcon.vue';

export default {
  name: "ContactList",
  components: {ContactListCom, AllPopup, Topbar, Sidebar, PlusIcon}
}
</script>
