                    ...
                    <div class="col-lg-8">
                        <div class="right-content">
                            ...
                            <div class="action-btn-main">
                                <a href="#" class="icon" @click="plusIcon">
                                    <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#262626" stroke="#262626" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M19.0674 12.5148V25.6202" stroke="white" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M25.6268 19.0675H12.5078" stroke="white" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </a>
