      ...
      <v-data-table v-model="selected" :headers="headers" :items="desserts" :page.sync="page"
        ...
        <template v-slot:item.customer>
          <td class="customer">
            ...
            <span class="address font-small">আচরি মার্কেট , সড়ক ১২, সেক্টর ৩, উত্তরা, ঢাকা
            </span>
        ...
        <template v-slot:item.buying_price>
          <td class="amount">
            <span class="amount-only">১২,৪৮৯.০০</span>
          </td>
        </template>

        <template v-slot:item.payment_mood>
          <td class="status">
