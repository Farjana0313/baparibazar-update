  ...
  <div>
            ...
            <span class="short-icon mr-4 mb-2">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M7.3147 11.6622L9.6597 14.0172L12.0047 11.6622"
                  fill="#E0E0E0"
                />
                <path
                  d="M7.3147 11.6622L9.6597 14.0172L12.0047 11.6622"
    ...
    <div class="table-area-wrapper order-table-content">
      ...
      >
        ...
        <template v-slot:item.rice_name>
          <td class="product-name">নাজিরশাইল</td>
        </template>
        <template v-slot:item.rice_company>
          <td class="product-company-name">মোজ্জামেল</td>
        </template>
        <template v-slot:item.wight>
          <td class="weight">২৫</td>
        </template>
        <template v-slot:item.price>
          <td class="price">১৭৬৫/-</td>
        </template>
        <template v-slot:item.last_update>
  ...
  data() {
    return {
      ...
      desserts: [
        {
          name: "১",
          rice_name: "বপ১২৫৬৫৯৮৪৩",
          rice_company: `	১৮/১০/২০২১
                          ৫ মিনিট আগে`,
          wight: `মের্সাস হালিমা স্টোর
