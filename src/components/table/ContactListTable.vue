    ...
    <div>
        ...
        <div class="table-area-wrapper contact-list-table-content">
            ...
            <v-data-table v-model="selected" :headers="headers" :items="desserts" :page.sync="page"
                :single-select="singleSelect" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" item-key="name"
                show-select :search="search" class="elevation-1" hide-default-footer>
                
                <template v-slot:footer> </template>
                <template v-slot:item.ownersName>
                                                        ...
                                                        <span class="icon">
                                                            <svg width="12" height="10" viewBox="0 0 12 10" fill="none"
                                                                ...
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                                    ...
                                                                    stroke="#828282" stroke-width="0.8"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
