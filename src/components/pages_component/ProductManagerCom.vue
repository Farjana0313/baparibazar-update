              ...
              <ul class="nav nav-tabs default-tab-button" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#one" role="tab"
                     aria-controls="one" aria-selected="true">Categories</a>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="three-tab" data-toggle="tab" href="#three" role="tab"
                     aria-controls="three" aria-selected="false">Products</a>
                </li>
              </ul>
              <!-- tab button area end -->
            </div>
            ...
            <div class="table-area-wrapper settings-table-content">
              <table>
                ...
                <tr>
                  ...
                  <th class="listed-sub-categories">
                    Listed Sub categories
                  </th>
                  <th class="product-listed">
                    Product Listed
                  </th>
                ...
                <tr class="sub-categories-item">
                  ...
                  <td class="listed-sub-categories">
                    ২৪
                  </td>
                  <td class="product-listed">
                    <span class="price-only">২৪</span>
                  </td>
                  ...
                  <td class="action">
                            <span class="checkboxes-and-radios">
                              <input type="checkbox" name="checkbox-cats[]" id="product-catg-1" value="1" checked="">
                              <label for="product-catg-1"></label>
                            </span>
                                ...
                                <div class="modal-control-02">
                                  <div class="modal-content">
                                    ...
                                    <div class="mini-modal-style-02">
                                      <ul class="list">
                                        <li class="list-item viewbtn" onclick="addCatgDetViewPopOpn()">
                                          <span class="icon">
                                        ...
                                        <li class="list-item editbtn" onclick="addCatgDetViewPopOpn()">
                                          <span class="icon">
            ...
            <div class="table-area-wrapper settings-table-content">
              <table>
                ...
                <tr class="sub-categories-item">
                  ...
                  <td class="name">
                    <span class="product-name">নাজিরশাইল</span>
                  </td>
                  <td class="product-listed">
                    <span class="price-only">২৪</span>
                  </td>
                  ...
                  <td class="action">
                            <span class="checkboxes-and-radios">
                              <input type="checkbox" name="checkbox-cats[]" id="sub-catg-1" value="1" checked="">
                              <label for="sub-catg-1"></label>
                            </span>
                    <span class="single-action-item">
                              <a href="#" class="action-btn" data-toggle="dropdown" aria-expanded="false">
                                <svg width="14" height="14" viewBox="0 0 13 13" fill="none"
                              ...
                              <div class="dropdown-menu dropdown-menu-right control">
                                <div class="modal-control-02">
                                  <div class="modal-content">
                                    ...
                                    <div class="mini-modal-style-02">
                                      <ul class="list">
                                        <li class="list-item viewbtn" onclick="addSbCatgViewPopOpn()">
                                          <span class="icon">
                                            <svg width="12" height="10" viewBox="0 0 12 10" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <li class="list-item editbtn" onclick="addSbCatgViewPopOpn()">
                                          <span class="icon">
                                            <svg width="10" height="9" viewBox="0 0 10 9" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div class="tab-pane fade" id="three" role="tabpanel" aria-labelledby="three-tab">
            <div class="table-area-wrapper settings-table-content">
              <table>
                ...
                <tbody>
                <tr class="single-product-manage-item">
                  <td class="sl-no">
                    <form action="/action_page.php">
                      <input type="checkbox" id="" name="" value="">
                    </form>
                  ...
                  <td class="action">
                            <span class="checkboxes-and-radios">
                              <input type="checkbox" name="checkbox-cats[]" id="product-1" value="1" checked="">
                              ...
                              <div class="dropdown-menu dropdown-menu-right control">
                                <div class="modal-control-02">
                                  <div class="modal-content">
                                    ...
                                    <div class="mini-modal-style-02">
                                      <ul class="list">
                                        <li class="list-item viewbtn" onclick="addProdOnePopOpn()">
                                          <span class="icon">
                                            <svg width="12" height="10" viewBox="0 0 12 10" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                              <path fill-rule="evenodd" clip-rule="evenodd"
